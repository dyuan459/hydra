...
from models.layers import SubnetConv
from utils.parse_config import parse_model_config
from utils.utils import weights_init_normal


def create_modules(module_defs: List[dict], arg) -> Tuple[dict, nn.ModuleList]:
    """
...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path, arg):
        super(Darknet, self).__init__()
        self.module_defs = parse_model_config(config_path)
        self.hyperparams, self.module_list = create_modules(self.module_defs, arg)
...
def load_model(model_path, arg, weights_path=None):
    ...
    model = Darknet(model_path, arg).to(device)
