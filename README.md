...
2. Extensive testing has not been done yet but there is an issue with out of bounds I can't seem to trace at the moment. Deeper testing recommended to verify pruning is done properly.
